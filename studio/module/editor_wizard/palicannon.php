...
<div class="editor_wizard">
	<div class="editor_wizard_nav">
		<button type="button" onclick="pc_show_res_selecter(false)">×</button>
	</div>
			...
			<div id="wizard_palicannon_par_select">
				...
				<div id="wizard_palicannon_par_select_text">
					<div id="wizard_palicannon_par_select_text_head">
						<h2 id="wizard_palicannon_par_select_text_head_bookname"><?php echo $module_gui_str['editor_wizard']['1012'];?>
							<div id="wizard_palicannon_par_select_text_head_button">
								<span class="PT_button"><button onclick="book_res_edit_now(1)"><?php echo $module_gui_str['editor_wizard']['1013'];?></button></span>
								<span class="PT_button"><button  onclick="book_res_add_to_list(1)"><?php echo $module_gui_str['editor_wizard']['1014'];?></button></span>
							</div>
